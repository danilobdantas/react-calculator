...
function Calculator() {
    ...
    function adicionarNumero(num) {
        let resultado;
        if (operacao === null) {
            resultado = concatenarNumero(numero1, num);
            setNumero1(resultado);
        }
        else {
            resultado = concatenarNumero(numero2, num);
    ...
    function definirOperacao(op) {
        //define operação se não tiver
        if (operacao === null) {
            setOperacao(op);
            return;
        }

        // tem operador e tem os dois números, calcula
        if (numero2 !== null) {
